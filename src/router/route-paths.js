...
export const SEARCH_CURATORY_GROUP_ROUTE = '/search-curatory-group'
...
export const EDIT_CURATORY_GROUP_ROUTE = '/curatory-group'
...
export const NOT_FOUND_ROUTE = '/:pathMatch(.*)'
