...
<script>
  ...
  import {SEARCH_CURATORY_GROUP_ROUTE} from "./router/route-paths.js";
    ...
    computed: {
      searchMenuItems () {
        const menuItems = [
          ...
          { icon: 'mdi-account-supervisor-circle', text: 'Kuratorengruppen', route: SEARCH_CURATORY_GROUP_ROUTE, needsLogin: true, needsRole: ROLE_ADMIN }
        ]
