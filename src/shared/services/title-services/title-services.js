...
const api = (baseServices) => ({
  get (id, cancelToken) {
    return baseServices.request({
      method: 'GET',
      url: import.meta.env.VITE_API_BASE_URL + `${PROVIDER_URL}/${id}?history=true`,
    }, cancelToken)
  },
  getTipps (id, parameter, cancelToken) {
    ...
    return baseServices.request({
      method: 'GET',
      url: import.meta.env.VITE_API_BASE_URL + `${PROVIDER_URL}/${id}/tipps?${urlParameter}`,
    }, cancelToken)
  },
  ...
  updateHistory (id, data, cancelToken) {
    const url = import.meta.env.VITE_API_BASE_URL + `${PROVIDER_URL}/${id}/history`
    return baseServices.request({
      method: 'PUT',
      url,
      data,
  ...
  merge (data, params, cancelToken) {
    ...
    const url = import.meta.env.VITE_API_BASE_URL + `${PROVIDER_URL}/${id}/merge?${queryParameters}`
    return baseServices.request({
      method: 'PUT',
      url,
      data,
